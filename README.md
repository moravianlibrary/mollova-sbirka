...
```
docker build -t trinera/moll-frontend:1.0.1 .
```

or including version tag and tag `latest`
```
docker build -t trinera/moll-frontend:latest -t trinera/moll-frontend:1.0.1 .
```
...
```
docker push trinera/moll-frontend:1.0.1
