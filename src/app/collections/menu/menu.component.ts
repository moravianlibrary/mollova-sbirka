...
export class MenuComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        const urlSub = this.route.url.subscribe((url) => {
            if (url.length === 0) {
                ...
                const collectionStructureSub = this.collectionService
                    .getCollectionStructureFromJSON()
                    .subscribe((collectionStructure) => {
                        if (collectionStructure) {
                            ...
                            console.warn(
                                'Collection structure is not available.',
                            );
                        }
                    });
        ...
        const mapSub = this.collectionService.hoverFromMap$.subscribe(
            (areaName) => {
    ...
    handleClickOnIcon(item: any): void {
